<template>
    <div class="flex flex-col gap-y-10 my-5 max-w-96 mx-auto hidden lg:block">
        <div class="title">
        ...
        <div class="form flex flex-col gap-y-5">
            ...
            <div class="flex justify-between items-center">
                <p class=" text-gray-500">Pengguna Baru ? <router-link :to="{ name: 'register' }"
                        class="font-semibold text-[#ff914d]">
                        Daftar
                    </router-link></p>
                <router-link :to="{ name: 'forgotpassword' }" class=" text-[#ff914d] font-semibold">Lupa
    ...
    <div class="container mx-auto px-3 lg:p-0 flex flex-col gap-y-10 justify-center h-screen  lg:hidden">
        <div class="title">
            <h3 class="text-md font-bold text-gray-500">Masuk ke Akun Kamu</h3>
            <p class="text-sm text-gray-500">Yuk intip ! ada diskon loh di toko kami</p>
        </div>
        ...
        <form @submit.prevent="login" class="form-login flex flex-col gap-y-3">
            <div class="form-label-group">
                ...
                <p v-if="validation.email" class="text-red-500 text-[11px]">{{ validation.email[0] }}</p>
            </div>
            ...
            <div class="form-label-group">
                ...
                <p v-if="validation.password" class="text-red-500 text-[11px]">{{ validation.password[0] }}</p>
            </div>
            <button class="bg-[#ff914d] px-5 py-2 w-full rounded-md  hover:shadow-md">

                <p v-if="!loading" class="font-semibold text-white text-[11px]">Masuk</p>
                <p v-else class="font-semibold text-white text-[11px]">Loading ...</p>
            </button>

            <div class="flex justify-between items-center">
                <p class="text-[11px] text-gray-500">Pengguna Baru ? <router-link :to="{ name: 'register' }"
                        class="font-semibold text-[#ff914d]">
                        Daftar
                    </router-link></p>
                <router-link :to="{ name: 'forgotpassword' }" class="text-[11px] text-[#ff914d] font-semibold">Lupa
                    Password</router-link>
